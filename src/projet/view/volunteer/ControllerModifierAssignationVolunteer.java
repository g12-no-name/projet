...
public class ControllerModifierAssignationVolunteer {
	...
	private void initialize() {
		...
		posteNom.setText(courant.getPoste().toString());
		textFieldPosteD.setText(courant.getPoste().getHeureD().toString());
		textFieldPosteF.setText(courant.getPoste().getHeureF().toString());
