...
INSERT INTO poste (id, nom, typePoste, heureD, heureF, xCarte, yCarte) VALUES
  (1, 'poste 1', 1, '15:05','15:15', 100,100),
  (2, 'poste 4', 3, '08:05','10:15',200,100),
  (3, 'I do', 2, '14:05','16:15',100,200),
  (4, 'not know', 2, '12:05','15:15', 6, 6),
  (5, 'what to do', 1, '15:05','15:15', 50, 50),
  (6, 'anymore', 2, '15:05','15:15', 300, 300),
  (7, 'velo', 2, '12:05','15:15', -100, -100),
  (8, 'gourdier', 1, '12:05','16:00', -100, -100),
  (9, 'gardien', 5, '15:05','16:15', -100, -100),
  (10, 'emissaire', 4, '12:05','15:15', -100, -100),
  (11, 'spadassin', 4, '15:05','16:15', -100, -100),
  (12, 'sentinelle',4, '12:05','15:15', -100, -100),
  (13, 'fleau', 4, '12:05','15:15', -100, -100),
  (14, 'victimaire', 5, '12:05','16:15', -100, -100),
  (15, 'hersir', 5, '12:05','15:15', -100, -100),
  (16, 'berserker', 5, '12:05','16:15', -100, -100),
  (17, 'valkyrie', 3, '15:05','16:15', -100, -100),
  (18, 'jarl', 3, '15:05','16:15', -100, -100),
  (19, 'chamane', 3, '12:05','16:15', -100, -100),
  (20, 'kensei', 2, '12:05','16:15', -100, -100),
  (21, 'orochi', 2, '15:05','16:15', -100, -100),
  (22, 'shugoki', 1, '15:05','15:15', -100, -100);
